export default {
  ...
  'installation.step2.cli.title': '⚡ Cài Nhanh (Terminal)',
  'installation.step2.cli.note': 'Tự động tải phiên bản mới nhất và cài đặt.',
  'installation.step2.manual.title': 'Cài Thủ Công',
