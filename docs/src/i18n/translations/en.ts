export default {
  ...
  'hero.linux.appimage.subtitle': 'All Linux distros',
  ...
  'installation.step2.cli.title': '⚡ Quick Install (Terminal)',
  'installation.step2.cli.note': 'Downloads the latest release and installs it automatically.',
  'installation.step2.manual.title': 'Manual Install',
  ...
  'installation.step2.linux.appimage.note': 'Universal format that works on all Linux distributions',
  ...
  'installation.troubleshooting.crash.step1': 'Use the .AppImage release — it works on all distros',
  'installation.troubleshooting.crash.step2': 'Ensure PulseAudio is installed: sudo apt install pulseaudio',
